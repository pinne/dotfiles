" ~/Documents/dotfiles/vim/sessions/default.vim: Vim session script.
" Created by session.vim 1.5 on 17 februari 2013 at 18:35:09.
...
setlocal fdn=20
setlocal fen
let s:l = 28 - ((12 * winheight(0) + 13) / 26)
